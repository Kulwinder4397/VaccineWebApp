...
namespace VaccineWebApp.Controllers
{
    ...
    public class HospitalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HospitalID,Name,Address,ContactNo")] Hospital hospital)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HospitalID,Name,Address,ContactNo")] Hospital hospital)
        {
